...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Augurs Example App'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '255d746d327ea36577efa3525bfeeecd'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'myshopify_domain' => env('SHOPIFY_MYSHOPIFY_DOMAIN', 'augurs-example-store.myshopify.com'),
    ...
    */
    ...
    'webhooks' => [
        ...
        */
        ...
        //     'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://augursteststore.myshopify.com/webhook/app-uninstalled')
        // ],
    ],
