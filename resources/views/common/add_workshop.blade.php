			                ...
			                <div class="card-body">
			                	<form id="workshop_form">
                                    ...
                                    <div class="form-group">
										...
										<input type="text" name="title" id="title" class="form-control" placeholder="WorkShop title" required="required" />
                                        <span id="title_err"></span>
									</div>
                                      ...
                                      <div class="d-flex justify-content-between align-items-center">
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input type="checkbox" class="form-control-styled paid_status" name="work_shop_paid" value="1" checked data-fouc required="required">
												Paid per hour
											</label>
										</div>
									</div>
                                    ...
                                    <div class="row form-group" id="paid_amount_div">
								     <div class="col-sm-12">
                                      <label>Amount</label>
                                       <input type="number" class="form-control" placeholder="Paid Amount" name="amount" value="{{ old('amount') }}" min="0"/>
                                     </div>
							        </div>
                                    <div class="row">
								     <div class="col-md-12 form-group">
                                       <label>About Workshop <span class="text-danger">*</span></label>
									   <textarea class="form-control" rows="5" name="description" id="description" value="{{ old('description') }}" placeholder="About Workshop" required="required"></textarea>
                                       <span id="title_err"></span>
								     </div>
                                    </div>
                                    <!--<div class="row form-group">
								     <div class="col-sm-3">
                                      <div class="d-flex justify-content-between align-items-center">
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input type="checkbox" class="form-control-styled paid" name="image_gallery" id="image_gallery" value="1" checked data-fouc>
...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active"> Add Workshop </span>
						</div>
