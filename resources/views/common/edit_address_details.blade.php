...
<div class="content">
	...
	<div class="card" id="workshop_details_section">
		<div class="card-header bg-light header-elements-inline">
			<h6 class="card-title">Edit Address Details</h6>
        ...
        <div class="card-body">
            <form id="edit_address_details_form">
                @csrf
                <input type="hidden" id="edit_address_id" name="edit_address_id" value="{{ $result->id }}">
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <textarea type="text" class="form-control" placeholder="@lang('messages.RegisteredOfficeAddress')" name="address_1" id="address_1" required>{{ $result->address_1 ?? '' }}</textarea>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="zip_code" id="zip_code" class="form-control" value="{{ $result->zip_code ?? '' }}" />
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-6">
                        <label>@lang('messages.Latitude') &nbsp;<span class="text-danger">*</span>&nbsp;</label>
                        <input type="text" name="latitude" id="latitude" class="form-control" value="{{ $result->latitude ?? '' }}" />
                    </div>
                    <div class="col-sm-6">
                        <label>@lang('messages.Longitude') &nbsp;<span class="text-danger">*</span>&nbsp;</label>
                        <input type="text" name="longitude" id="longitude" class="form-control" value="{{ $result->longitude ?? '' }}" />
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center">
					<button type="submit" id="edit_address_btn" class="btn bg-blue ml-3">@lang('messages.Submit') <i class="icon-paperplane ml-2"></i></button>
				</div>
            </form>
        </div>
	</div> 
...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
	<div class="d-flex">
		<div class="breadcrumb">
			...
			<span class="breadcrumb-item active"> Edit Address Details </span>
		</div>
...
@push('scripts')
  ...
  <!-- <script src="{{ url('validateJS/common.js') }}"></script> -->
