		...
		<form id="coupon_form">
            ...
            <div class="row form-group" id="">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control datepicker" name="launching_date" placeholder="@lang('messages.StartDate')" value="<?php if(!empty($coupons_details)) echo $coupons_details->launching_date; ?>" readonly="readonly" required="required"/>
				</div>
				<div class="col-sm-6">
					<label>Closed On&nbsp;<span class="text-danger">*</span></label>
					<input type="text" class="form-control datepicker" name="closed_date" placeholder="@lang('messages.ClosingDate')" value="<?php if(!empty($coupons_details)) echo $coupons_details->closed_date; ?>" readonly="readonly" required="required"/>
				</div>
			</div>
            <div class="row form-group" id="">
				<div class="col-sm-6">
					<label>Available Date&nbsp;<span class="text-danger">*</span></label>
					<input type="text" class="form-control datepicker" name="avail_date" placeholder="@lang('messages.AvailableDate')" value="<?php if(!empty($coupons_details)) echo $coupons_details->avail_date; ?>" readonly="readonly"  required="required"/>
				</div>
				<div class="col-sm-6">
					<label>Expiry Date<span class="text-danger">*</span></label>
					<input type="text" class="form-control datepicker" name="avail_close_date" placeholder="@lang('messages.ExpiryDate')" value="<?php if(!empty($coupons_details)) echo $coupons_details->avail_close_date; ?>"  readonly="readonly" required="required"/>
				</div>
			</div>
            <div class="row">
                <div class="col-md-12 form-group">
                    <label>No. Of Coupon Being Purchased&nbsp;<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="per_user_allot" placeholder="@lang('messages.NoOfCoupon')" value="<?php if(!empty($coupons_details)) echo $coupons_details->per_user_allot; ?>"  required="required"/>
                    <span id="title_err"></span>
                </div>
            </div>
            <div class="col-md-12 form-group">
