...
<div class="card collapse" id="add_revision_special_condition" >
    <div class="card-header bg-light header-elements-inline">
        <h6 class="card-title" style="font-weight:600;"><i class="fa fa-plus"></i>&nbsp;Request Quotes Special Condition</h6>
    </div>
	<div class="card-body">
        <form id="special_request_Quotes_condition_form" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit" id="quotes_special_condition_btn" class="btn bg-blue ml-3">Submit <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </div>
        </form>
	</div>
...
<div class="card-header bg-light header-elements-inline">
        <h6 class="card-title" style="font-weight:600;"><i class="fa fa-list"></i>&nbsp;Request Quotes Special Conditions</h6>
    </div>
            ...
            <tbody>
                @forelse ($special_conditions as $special_condition)
                    <tr>
                        ...
                        <td>{{ $special_condition->service }}</th>
                        ...
                        <td class="text-center">
                            ...
                            @endif
                            &nbsp;&nbsp;&nbsp;&nbsp;<a href='{{ url("spacial_condition/edit_request_quots/$special_condition->enctype_id") }}' data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-sm" ><i class="fa fa-edit"></i></a>
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">Service Quotes  </span>
