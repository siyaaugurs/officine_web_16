                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="car_size" id="car_size" >
                            <option value="4">All Size</option>
            ...
            <tbody>
                @forelse ($special_conditions as $special_condition)
                    <tr>
                        ...
                        @if($special_condition->car_size == 1)
                            <td>Small</th>
                        @elseif($special_condition->car_size == 2)
                            <td>Average</th>
                        @elseif($special_condition->car_size == 3)
                            <td>Big</th>
                        @elseif($special_condition->car_size == 4)
                            <td>All Size</th>
                        @endif
                        <td>
                        ...
                        <td class="text-center">
                            ...
                            @endif
                            &nbsp;&nbsp;&nbsp;&nbsp;<a href='{{ url("spacial_condition/edit_washing/$special_condition->enctype_id") }}' data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-sm" ><i class="fa fa-edit"></i></a>
