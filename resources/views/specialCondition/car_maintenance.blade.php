...
<div class="card collapse" id="add_maintenance_special_condition" >
    <div class="card-header bg-light header-elements-inline">
        <h6 class="card-title" style="font-weight:600;"><i class="fa fa-plus"></i>&nbsp;@lang('messages.CarMaintenanceSpecialCon')</h6>
    </div>
	<div class="card-body">
        <form id="special_maintenance_condition_form" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit" id="maintenance_special_condition_btn" class="btn bg-blue ml-3">Submit <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </div>
        </form>
	</div>
...
<div class="card-header bg-light header-elements-inline">
        <h6 class="card-title" style="font-weight:600;"><i class="fa fa-list"></i>&nbsp;Car Maintenance Special Conditions</h6>
    </div>
		...
		<table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($special_condition->item == NULL)
                        <td>All Services</th>
                    @else 
                        <td>{{ $special_condition->item }}</th>
                    @endif
                    ...
                    <td class="text-center">
                        ...
                        @endif
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href='{{ url("spacial_condition/edit_maintenance/$special_condition->enctype_id") }}' data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-sm" ><i class="fa fa-edit"></i></a>
