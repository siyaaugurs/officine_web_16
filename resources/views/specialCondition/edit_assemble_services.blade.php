...
<div class="card" id="add_maintenance_special_condition" >
    ...
    <div class="card-body">
        <form id="edit_assemble_special_condition_form" autocomplete="off">
            @csrf
            <input type="hidden" name="special_condition_id" id="special_condition_id" value="{{ $assemble_details->id }}">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category_id" id="category_id">
                            <option value="0">All Services</option>
                                @foreach($assemble_services_category as $category)
                                    <option value="{{ $category->id }}" {{ $category->id == $assemble_details->category_id ? 'selected' : ''}}>{{ $category->main_cat_name }}</option>
                                @endforeach 
                        </select>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    <select class="form-control makers" name="car_makers" id="makers">
                       ...
                       <option value="1" {{ $assemble_details->makers == 1  ? 'selected' : ''}}>All Cars</option>
                         @foreach($cars__makers_category as $makers)
                           <option value="@if(!empty($makers->idMarca)){{ $makers->idMarca }} @endif" {{ $makers->idMarca == $assemble_details->makers ? 'selected' : ''}}>@if(!empty($makers->Marca)){{ $makers->Marca }} @endif</option>
                         @endforeach 
                    </select>                                
                </div> 
              </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="operation_type" id="operation_type" required >
                            <option value="1" {{ $assemble_details->operation_type == 1 ? 'selected' : ''}}>Special Price</option>   
                            <option value="2" {{ $assemble_details->operation_type == 2 ? 'selected' : ''}}>Do not perform operation</option>   
                        </select>
                    </div>   
                </div>
            </div>  
            ...
            <div class="row">
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="start_time" name="start_time" placeholder="@lang('messages.StartTime')" required value="{{ $assemble_details->start_hour }}" />
                </div>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="end_time" name="end_time" placeholder="@lang('messages.EndTime')" required value="{{ $assemble_details->end_hour }}" />
                </div>
            </div>
            <div class="row rowPadding">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="discount_type" id="discount_type">
                            ...
                            <option value="1" {{ $assemble_details->discount_type == 1 ? 'selected' : ''}}>Price per hour </option>   
                            <option value="2" {{ $assemble_details->discount_type == 2 ? 'selected' : ''}}>Discount Percentage </option> 
                        </select>
                        <span id="title_err"></span>
                    </div>   
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="amount" name="amount" placeholder="@lang('messages.Amount')" value="{{ $assemble_details->amount_percentage }}" />
                    </div>
                </div>   
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="maximum_appointment" name="maximum_appointment" placeholder="@lang('messages.maxAppointment')" required value="{{ $assemble_details->max_appointement }}" />
                    </div>
                </div>   
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" name="start_date" placeholder="@lang('messages.StartDate')" id="start_date" value="{{ $assemble_details->start_date }}" readonly="readonly"  required/>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="repeat_type" id="repeat_type">
                            <option value="0" {{ $assemble_details->select_type == 0 ? 'selected' : ''}}>Select type</option>   
                            <option value="1" {{ $assemble_details->select_type == 1 ? 'selected' : ''}}>Every Day</option>   
                            <option value="2" {{ $assemble_details->select_type == 2 ? 'selected' : ''}}>Every Week</option>   
                            <option value="3" {{ $assemble_details->select_type == 3 ? 'selected' : ''}}>Every Month</option>   
                            <option value="4" {{ $assemble_details->select_type == 4 ? 'selected' : ''}}>Every Year</option>   
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="expiry_date" name="expiry_date" placeholder="@lang('messages.ExpiryDate')" value="{{ $assemble_details->expiry_date }}"  readonly="readonly" required/>
                    </div>
                </div>
            </div>
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit" id="edit_assemble_special_condition_btn" class="btn bg-blue ml-3">Submit <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </div>
        </form>
    </div>
