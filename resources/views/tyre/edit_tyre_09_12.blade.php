                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="quantity" placeholder="Products Quantity" id="input-price" value="<?php if(!empty($tyre->quantity)) echo $tyre->quantity; ?>" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                @if(!empty($tyre->tyre_resp->imageUrl))
                                  <div class="col-sm-4 col-md-3 col-lg-3">
                                        <div class="card">
                                            ...
                                            <img class="card-img img-fluid" src="{{ $tyre->tyre_resp->imageUrl }}" alt="" />
                                                <div class="card-img-actions-overlay card-img">
                                                    <a href="{{ $tyre->tyre_resp->imageUrl }}" class="btn btn-outline bg-white text-white border-white border-2 btn-icon rounded-round" data-popup="lightbox" rel="group">
                    ...
                    <div class="tab-pane" id="tab-tyredescription">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-price">Tyre Type</label>
                            <div class="col-sm-10">
                                    ...
                                    <option value="0">--Select--Tyre--Type--</option>
                                     <?php 
									   foreach($tyre_type as $t_type){
										     ?>
											<option value="<?php if(!empty($t_type['code'])) echo $t_type['code']; ?>" <?php if($t_type['code'] == $tyre->type)echo "Selected"; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" name="manufacturer_description" id="manufacturer_description"  placeholder="Seller Price" id="input-price" value="<?php if(!empty($tyre->tyre_resp->manufacturer_description)) if(!is_object($tyre->tyre_resp->manufacturer_description)) echo  $tyre->tyre_resp->manufacturer_description; else{ echo "N/A"; }?>" class="form-control"  />
                            </div>
                        </div>
                        <div class="form-group" id="tax_value_div" style="display:none;">
                            <label class="col-sm-2 control-label" for="input-tax-class">Tax Amount</label>
