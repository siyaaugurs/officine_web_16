        ...
        <tbody>
           @forelse($listed_services as $service)
             @php
              ...
              $versions = kRomedaHelper::get_version_name($service->models_name , $service->car_version_id); 
             @endphp
             ...
             <tr>
                    ...
                    <th><?php echo $versions->Versione; ?></th>
                    ...
                    <td>
                        ...
                        <!-- <a href='{{ url("workshop/edit_assemble_services/$enc_type_s_id") }}' class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a> -->
                    </th>
                </tr>
           @empty
            <tr>
        ...
        <div class="card-body">
            <form id="assemble_products_service_form" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="group_item" id="group_item">
                        <option value="0">--First--Select--Version--Name--</option>
                    </select>
                </div>
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control multiselect" name="products_id"  id="products_id">
                                <option value="0">--Select--GroupItem--First--</option>
                        </select>
                    </div>
                </div>
                <div class="row form-group">
