            ...
            <div class="container">
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                            ...
                            <select name="group_n1" id="group_n1" class="form-control groups" data-action="get_sub_category">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control sub_groups"  name="" data-action="get_n3_category">
                    ...
                    <div class="tab-pane" id="tab-general">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="products_name"  placeholder="Item" class="form-control" value="<?php if(!empty($product_details->products_name)) echo $product_details->products_name; ?>" />
                            </div>
                        </div>
                        <div class="form-group required">
