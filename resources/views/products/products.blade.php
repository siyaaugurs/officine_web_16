...
<div class="card-header bg-light header-elements-inline">
        <h6 class="card-title" style="font-weight:600;"><i class="fa fa-list"></i>&nbsp;@lang('messages.AddNewProducts')</h6>
        </div>
@if(Session::has('msg'))
  {!!  Session::get("msg") !!}
@endif          
                                ...
                                <form id="add_products_by_admin">
                                 ...
                                 <div class="form-group">
								   <button type="submit" class="btn btn-success" style="float:;" id="products_save_button">Save&nbsp;<span class="glyphicon glyphicon-plus"></span></button>
									 &nbsp;
							    	<a href='{{ url("products/products_list") }}' target="_blank" class="btn btn-primary" style="color:white;" id="view_all_group">Products List &nbsp;<span class="glyphicon glyphicon-list"></span></a> </div>
                                 	<div class="form-group">
